...
- Se actualizaron las categorías `Profe 1` y `Profe 2`.
- Los temas ahora son:
  - PIAR
  - Mallas Curriculares
  - Cultura General
  - Variedades del Mundo Escolar
- Cada categoría de profes incluye 15 preguntas de PIAR para escuelas en Colombia.
- Se agregaron preguntas nuevas para mallas curriculares, cultura general y variedades del mundo escolar relacionadas con escuela y docentes.
- No se modificó la lógica del juego, puntajes, buzzer, sonidos, diseño ni finales generales.
